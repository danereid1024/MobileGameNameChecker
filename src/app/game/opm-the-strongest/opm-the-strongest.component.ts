...
@Component({
  selector: 'app-opm-the-strongest',
  imports: [FormsModule, CommonModule],
  template: `
  <div class="content">
  <div class="title">
  <h1>One Punch Man: The Strongest Name Checker</h1>
  </div>
...
export class OpmTheStrongestComponent {
  ...
  getOnePunchMan() {
    if (this.id.trim() === '') {
      alert("Please insert user ID and zone_id ID!")
    }
