...
@Component({
  selector: 'app-teen-patti-gold',
  imports: [FormsModule, CommonModule],
  template: `
    <div class="content">
  <div class="title">
  <h1>Teen Patti Gold Name Checker</h1>
  </div>
  ...
  <div class="input">
  <input matInput class="text" type="text" [(ngModel)]="server" name="server">
  </div>
...
export class TeenPattiGoldComponent {
