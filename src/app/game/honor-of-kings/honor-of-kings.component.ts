...
@Component({
  selector: 'app-honor-of-kings',
  imports: [FormsModule, CommonModule],
  template: `
  <div class="content">
  <div class="title">
  <h1>Honor of Kings Name Checker</h1>
  </div>
  ...
  <div class="button">
  <button type="button" class="btn btn-primary" (click)="getHonorOfKings()">Check ID</button>
  </div>
  </div>
  `,
  styles: `
...
export class HonorOfKingsComponent {
