...
@Component({
  selector: 'app-arena-of-valor',
  imports: [FormsModule, CommonModule],
  template: `
  <div class="content">
  <div class="title">
  <h1>Arena of Valor Name Checker</h1>
  </div>
  ...
  <div class="button">
  <button type="button" class="btn btn-primary" (click)="getArenaOfValor()">Check ID</button>
  </div>
  </div>
  `,
  styles: `
...
export class ArenaOfValorComponent {
