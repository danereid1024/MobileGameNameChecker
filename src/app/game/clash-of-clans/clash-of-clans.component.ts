...
@Component({
  selector: 'app-clash-of-clans',
  imports: [FormsModule, CommonModule],
  template: `
  <div class="content">
  <div class="title">
  <h1>Clash of Clans Name Checker</h1>
  </div>
...
export class ClashOfClansComponent {
  ...
  getClashOfClans() {
    ...
    this.nameCheckerService.getClashOfClans(this.tag).subscribe({  
      next: (data) => {
        this.nameData = data;
        data.status
        console.log(
