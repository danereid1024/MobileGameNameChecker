...
export class NavComponent {
  ...
  navItems: string[] = ['valorant', 'mobile-legends', 'jawaker', 'pubg', 'royal-dream', 'teen-patti-gold', 'brawl-stars', 'clash-royale', 'coc', 'higgs-domino', 'genshin', 'point-blank', 'arena-of-valor', 'cod-mobile', 'ace-racer', 'lifeafter', 'dragon-raja', 'eggy-party', 'hayday', 'blood-strike', 'tom-and-jerry-chase', 'speed-drifters', 'revelation', 'opm-the-strongest', 'mu-origin-3', 'mu-devils-awaken', 'metal-slug', 'honor-of-kings'];

  get sortedNavItems() {
    return this.navItems.slice().sort((a,b) => a.localeCompare(b));
